...
<%
    ...
    List<RecordVO> list = recordSvc.getMemRecords(mem_no);
    ...
    <div class="row align-items-center justify-content-around">
        ...
        <main role="main" class="col-10 px-4" id="RecordPage">
            ...
            <div class="row align-items-center justify-content-center p-4">
                ...
                <div class="col-12 text-center mb-4" id="Control-panel">
                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-4 text-left">
                            <h2 class="display-4" style="color: #0c5460;">我的里程</h2>
                        </div>
                ...
                <div class="col-12 align-middle" id="RecordList">
                    ...
                    <table class="table table-striped text-center">
                        ...
                        <c:forEach var="recordVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>" varStatus="count">
