...
<%
	List<MemVO> listMem_ByCompositeQuery = (List<MemVO>) request.getAttribute("listMem_ByCompositeQuery");
%>
			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="col-10 align-middle" id="ManagerListTable">
					...
					<table class="table table-striped text-center">
						...
						<c:forEach var="memVO" items="${requestScope.listMem_ByCompositeQuery}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
						<tr>
