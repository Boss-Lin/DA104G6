...
<%
	...
	List<Blog_ReportVO> blogReportListStatus2 = blogReportList.stream()
		.filter(blog_reportVO ->blog_reportVO.getStatus()!=1)
		.collect(Collectors.toList());
 	
	
	pageContext.setAttribute("blogReportListStatus2", blogReportListStatus2);
				...
				<div class="col-10 align-middle" id="ManagerListTable" style="width: 80em">
				   <table class="table table-hover" style= "word-break:break-all" >
					  ...
					  <%@ include file="page1_1.file"%>
					    <c:forEach var="Blog_ReportVO" items="${blogReportListStatus2}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>" >
