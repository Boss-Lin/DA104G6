...
<%
	List<MemberReportVO> statusList = (List<MemberReportVO>) request.getAttribute("searchWithStatusList");
%>
			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="col-10 align-middle" id="ManagerListTable">
					...
					<table class="table table-striped text-center">
						...
						<tbody>
						<%@ include file="page1_BySearchByStatus.file" %>
						<c:forEach var="reportVO" items="${requestScope.searchWithStatusList}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>" varStatus="count">
						<tr>
							...
							<td style="overflow-y: auto;width: 500px;height: 175px;display: block;word-break: break-all">${reportVO.reason}</td>
								...
								<div class="modal-dialog modal-dialog-centered" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<input type="hidden" name="pageStatus" value="${reportVO.status}">
											<input type="hidden" name="rep_no" value="${reportVO.rep_no}">
											<input type="hidden" name="requestURL"	value="<%=request.getServletPath()%>"><!--送出本網頁的路徑給Controller-->
											<input type="hidden" name="requestForStatus"	value="<%=request.getServletPath() + "?" + request.getQueryString()%>"><!--送出本網頁的路徑給Controller-->
					...
					<%@ include file="page2_BySearchByStatus.file" %>
