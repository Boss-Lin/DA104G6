...
public class GroupVO implements Serializable, Comparable<GroupVO>{
	...
	public int compareTo(GroupVO o) {
		if(Integer.parseInt(gro_no.substring(4)) < Integer.parseInt(o.gro_no.substring(4)))
			return 1;
	...
	public String toString() {
		...
		builder.append(gro_no).append("\n").append(gro_name).append("\n").append(mem_no).append("\n").append(muster).append("\n")
		.append(time).append("\n").append(String.valueOf(duration)).append("\n").append(String.valueOf(peo_limit)).append("\n")
		.append(intro).append("\n").append(phone).append("\n").append(String.valueOf(status)).append("\n").append(route_no).append("\n")
		.append(String.valueOf(comfirm_mem)).append("\n").append(deadline).append("\n").append(create_time).append("\n").append(String.valueOf(total_review)).append("\n");
