...
public class MemVO implements Serializable,Comparable<MemVO>{
	...
	public MemVO(String mem_no, String mem_email, String mem_psw, String mem_name, Date mem_dob, int mem_gender,
			byte[] mem_img, String mem_address,  int mem_point, String rank_no, Timestamp jointime, int status, int total_record) {
		super();
		this.mem_no = mem_no;
